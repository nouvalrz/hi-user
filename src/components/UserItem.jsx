...
function UserItem({ user }) {
  ...
  return (
    <Card className="border border-gray-200 p-5 flex flex-col items-center">
      ...
      />
      <h2 className="font-medium mt-1 text-lg hover:text-sky-600 cursor-pointer hover:font-semibold">
        {first_name} {last_name}
      </h2>
      <p className="text-xs bg-gray-100 px-3 py-1 rounded-full my-1">{role}</p>
